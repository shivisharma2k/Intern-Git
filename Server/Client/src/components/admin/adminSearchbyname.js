            ...
            <div className="jumbotron" style={{minHeight:"545px"}}>
                <div className="row row-header">
                    ...
                    <div class="input-field row"  style={{margin:"0.5% 0% 0% 42%"}}>
                            <input type="text" placeholder=" search by name" className="white" value={name} onChange={(e)=>setName(e.target.value)}
...
export default AdminSearchbyname
