...
const AdminSearchbybranch = () =>{
    const [branch,setBranch] = useState("")
    const [data,setData] = useState([])

    const Search = () =>{
        fetch(`/branchsearch/${branch}`,{
            headers:{
            ...
            <div className="jumbotron" style={{minHeight:"545px"}}>
                <div className="row row-header">
                    ...
                    <div class="input-field row"  style={{margin:"0.5% 0% 0% 42%"}}>
                            <input type="text" placeholder=" search by branch" className="white" value={branch} onChange={(e)=>setBranch(e.target.value)}
...
export default AdminSearchbybranch
