...
const AdminSearchbyyear = () =>{
    const [year,setYear] = useState("")
    const [data,setData] = useState([])

    const Search = () =>{
        fetch(`/yearsearch/${year}`,{
            headers:{
            ...
            <div className="jumbotron" style={{minHeight:"545px"}}>
                <div className="row row-header">
                    ...
                    <div class="input-field row"  style={{margin:"0.5% 0% 0% 42%"}}>
                            <input type="text" placeholder=" search by year" className="white" value={year} onChange={(e)=>setYear(e.target.value)}
...
export default AdminSearchbyyear
