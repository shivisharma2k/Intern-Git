...
const AdminSearchbymentor = () =>{
    const [mentor,setMentor] = useState("")
    const [data,setData] = useState([])

    const Search = () =>{
        fetch(`/mentorsearch/${mentor}`,{
            headers:{
            ...
            <div className="jumbotron" style={{minHeight:"545px"}}>
                <div className="row row-header">
                    ...
                    <div class="input-field row"  style={{margin:"0.5% 0% 0% 42%"}}>
                            <input type="text" placeholder=" search by mentor" className="white" value={mentor} onChange={(e)=>setMentor(e.target.value)}
...
export default AdminSearchbymentor
